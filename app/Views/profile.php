...
<div class="row">
    ...
    <p class="text-center mb-0"><?= $Benevoles['lastname']." ".$Benevoles['firstname']?></p>
    <p class="text-center mb-0"><?= $Benevoles['phone']?> <i class="fa-solid fa-euro-sign"></i></p>
     ...
     <label for="lastname" class="form-label">changer votre nom</label>
        <input class="form-control" value="<?= $Benevoles['lastname']?>" id="lastname" type="text" name="lastname"  required>
            <label for="firstname" class="form-label">changer votre prenom</label>
                <input class="form-control" id="firstname" value="<?=$Benevoles['firstname']?>" type="text" name="firstname" required>
                <label for="address" class="form-label">changer votre address</label>
                <input class="form-control" id="address" value="<?=$Benevoles['address']?>" type="text" name="address" required>
                <label for="zipcode" class="form-label">changer votre code postale</label>
                <input class="form-control" value="<?= $Benevoles['zipcode']?>" id="zipcode" type="text" name="zipcode" required>
                <label for="city" class="form-label">changer votre code ville</label>
                <input class="form-control" id="city" value="<?=$Benevoles['city']?>" type="text" name="city" required>
                <label for="country" class="form-label">changer votre pays</label>
                <input class="form-control" id="country" value="<?=$Benevoles['country']?>" type="text" name="country" required>
