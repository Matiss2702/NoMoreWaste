    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="mb-3 d-grid text-center form-group">
          ...
          <button class="btn btn-primary d-flex mx-auto" onclick="modify_Conditions($('#modify-modal').data('id'),'<?php echo csrf_hash() ?>')">modifié</button>
        </div>
  ...
  <div class="modal" id="delete-modal" data-id="">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3 d-grid text-center form-group">
            êtes vous sûr de vouloir supprimer ce Condition ?
          </div>
